...
{
    public static class Pack2StreamReaderExtensions
    {
        /// <summary>
        ...
        public static async Task ExportAllAsync(this Pack2StreamReader reader, string outputPath, Dictionary<ulong, string> hashedNamePairs, CancellationToken ct = default)
        {
        ...
        /// <param name="outputPath">The path to export the assets to.</param>
        /// <param name="hashedNamePairs">A mapping of CRC-64 hashes to their original file name strings, so the assets can be exported with sane file names.</param>
        public static void ExportAll(this Pack2StreamReader reader, string outputPath, Dictionary<ulong, string> hashedNamePairs)
        {
            if (!Directory.Exists(outputPath))
                throw new DirectoryNotFoundException(outputPath);
        ...
        /// <param name="ct">A <see cref="CancellationToken"/> used to stop the operation.</param>
        /// <returns>A <see cref="Task"/> representing the asynchonous operation.</returns>
        public static async Task ExportAllAsync(this Pack2StreamReader reader, string outputPath, IEnumerable<string>? nameList = null, CancellationToken ct = default)
        {
        ...
        /// <param name="outputPath">The path to export the assets to.</param>
        /// <param name="nameList">An optional namelist so the assets can be exported with sane file names.</param>
        public static void ExportAll(this Pack2StreamReader reader, string outputPath, IEnumerable<string>? nameList = null)
        {
            Dictionary<ulong, string> hashedNamePairs = nameList is null ? new() : PackCrc.HashStrings64(nameList);
        ...
        /// <param name="ct">A <see cref="CancellationToken"/> used to stop the operation.</param>
        /// <returns>A <see cref="Task"/> representing the asynchonous operation.</returns>
        public static async Task ExportNamedAsync(this Pack2StreamReader reader, string outputPath, Dictionary<ulong, string> hashedNamePairs, CancellationToken ct = default)
        {
            if (!Directory.Exists(outputPath))
                throw new DirectoryNotFoundException(outputPath);
        ...
        /// <param name="outputPath">The path to export the assets to.</param>
        /// <param name="hashedNamePairs">A mapping of CRC-64 hashes to the original file name strings.</param>
        public static void ExportNamed(this Pack2StreamReader reader, string outputPath, Dictionary<ulong, string> hashedNamePairs)
        {
            if (!Directory.Exists(outputPath))
                throw new DirectoryNotFoundException(outputPath);
        ...
        /// <param name="ct">A <see cref="CancellationToken"/> used to stop the operation.</param>
        /// <returns>A <see cref="Task"/> representing the asynchonous operation.</returns>
        public static async Task ExportNamedAsync(this Pack2StreamReader reader, string outputPath, IEnumerable<string> nameList, CancellationToken ct = default)
        {
        ...
        /// <param name="outputPath">The path to export the assets to.</param>
        /// <param name="nameList">A list of the original file names.</param>
        public static void ExportNamed(this Pack2StreamReader reader, string outputPath, IEnumerable<string> nameList)
        {
            Dictionary<ulong, string> hashedNamePairs = PackCrc.HashStrings64(nameList);
